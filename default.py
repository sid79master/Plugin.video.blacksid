...
SOURCES = [{"url": "http://serveriptvpy.com/iptvpy.xml", "fanart": "https://filemanager.one.com/api/webspace/1/drive/serveriptvpy.com/data/fanart.jpg?width=800&height=800", "genre": "Tv Live", "date": "08.01.2015", "credits": "sid79", "thumbnail": "https://filemanager.one.com/api/webspace/1/drive/serveriptvpy.com/data/icon.png"}]

# https://filemanager.one.com/api/webspace/1/drive/serveriptvpy.com/data/fanart.jpg?width=800&height=800
# https://filemanager.one.com/api/webspace/1/drive/serveriptvpy.com/data/icon.png
...
def addon_log(string):
    if debug == 'true':
        xbmc.log("[addon.yulfiostv-%s]: %s" %(addon_version, string))
...
def makeRequest(url, headers=None):
        try:
            ...
            if hasattr(e, 'code'):
                ...
                xbmc.executebuiltin("XBMC.Notification(sid79,We failed with error code - "+str(e.code)+",10000,"+icon+")")
...
def addSource(url=None):
        ...
        xbmc.executebuiltin("XBMC.Notification(sid79,New source added.,5000,"+icon+")")
        if not url is None:
